...
class CfgVehicles {
    ...
    class BJK_LR_Vanquisher_Modified : TIOW_LR_BattleCannon {
        ...
        hiddenSelections[] = {"markings", "Camo"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\Data\Textures\Vehicles\BJK_Executioner_Modified_Markings_CO.paa", "BaY_JKaara_Armoury\Data\Textures\Vehicles\BJK_Executioner_Modified_CO.paa"};
        class Turrets : Turrets {
            class MainTurret : MainTurret {
