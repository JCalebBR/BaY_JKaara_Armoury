...
class CfgWeapons {
    // Tau Headgear
    class TIOW_Tau_HelmetS;
    class BJK_Strike_Helmet : TIOW_Tau_HelmetS {
        author = "JCaleb2014";
        displayName = "[Ba'Y JK] Strike Helmet";
        scope = 2;
        scopeArsenal = 2;
        scopeCurator = 2;
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_CO.paa"};
    ...
    class BJK_Strike_Helmet_Commander : BJK_Strike_Helmet {
        displayName = "[Ba'Y JK] Strike Helmet (Shas'Ui)";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_Commander_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Commander_CO.paa"};
    };
    class BJK_Strike_Helmet_Ethereal : BJK_Strike_Helmet_Commander {
        displayName = "[Ba'Y JK] Strike Helmet (Aun'La)";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_Ethereal_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Commander_CO.paa"};
        hiddenSelectionsMaterials[] = {"BaY_JKaara_Armoury\bjk_headgear\Materials\BJK_Strike_Helmet_Ethereal.rvmat"};
    };
    class BJK_Strike_Helmet_Medical : BJK_Strike_Helmet {
        displayName = "[Ba'Y JK] Strike Helmet (Medical)";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Medical_CO.paa"};
    };
    class BJK_Breacher_Helmet : BJK_Strike_Helmet {
        displayName = "[Ba'Y JK] Breacher Helmet";
        model = "\40k_tau\Headgear\HelmetB2.p3d";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Breacher_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_CO.paa"};
        class ItemInfo : ItemInfo {
    ...
    class BJK_Breacher_Helmet_Commander : BJK_Breacher_Helmet {
        displayName = "[Ba'Y JK] Breacher Helmet (Shas'Ui)";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Breacher_Helmet_Commander_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Commander_CO.paa"};
        class ItemInfo : ItemInfo {
            hiddenSelections[] = {"Camo", "Camo1"};
            hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Breacher_Helmet_Commander_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Commander_CO.paa"};
        };
    };
    class BJK_Pathfinder_Helmet : BJK_Strike_Helmet {
        displayName = "[Ba'Y JK] Pathfinder Helmet";
        model = "\40k_tau\Headgear\HelmetP.p3d";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_CO.paa"};
        class ItemInfo : ItemInfo {
            uniformModel = "\40k_tau\Headgear\HelmetP.p3d";
            hiddenSelections[] = {"Camo", "Camo1"};
            hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_CO.paa"};
        };
    };
    class BJK_Pathfinder_Helmet_Medical : BJK_Pathfinder_Helmet {
        displayName = "[Ba'Y JK] Pathfinder Helmet (Medical)";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Medical_CO.paa"};
        class ItemInfo : ItemInfo {
            hiddenSelections[] = {"Camo", "Camo1"};
    ...
    class BJK_Pathfinder_Helmet_Commander : BJK_Strike_Helmet {
        displayName = "[Ba'Y JK] Pathfinder Helmet (Shas'Ui)";
        model = "\40k_tau\Headgear\HelmetP.p3d";
        hiddenSelections[] = {"Camo", "Camo1"};
        hiddenSelectionsTextures[] = {"BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Strike_Helmet_Commander_CO.paa", "BaY_JKaara_Armoury\bjk_headgear\Textures\BJK_Tau_Headset_Commander_CO.paa"};
        class ItemInfo : ItemInfo {
